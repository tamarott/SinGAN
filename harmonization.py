...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref_dir', help='input paint dir', default='Input/Harmonization')
    parser.add_argument('--ref_name', help='ref image name', required=True)
    parser.add_argument('--harmonization_start_scale', help='harmonization start scale', type=int, required=True)
